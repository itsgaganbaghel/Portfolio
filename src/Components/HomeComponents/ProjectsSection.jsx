    ...
    <>
      <section className="relative w-full flex justify-center  lg:mt-52 mt-32 mb-20 lg:h-[45vh] overflow-hidden   ">
        ...
        <motion.section
          ...
          className=" z-30"
        >
          <p className=" border border-gray-800 bg-primary rounded-xl lg:text-6xl text-4xl font-serif px-8  py-3 mb-4">
            Featured Projects
          </p>
      ...
      <section className="relative w-full flex flex-col h-[300vh]  gap-[30vh] lg:px-12 px-4">
        {allProjects[0].projects.map((project, index) => {
          return (
            <section
              key={project?.name}
              className={`sticky lg:top-24  top-32 w-full md:w-[80%] lg:w-full  md:mx-auto lg:h-[80vh] h-[70vh] bg-primary grid grid-cols-1 grid-rows-[14%_46%_40%] md:grid-rows-[14%_56%_30%] lg:grid-rows-[25%_75%] lg:grid-cols-[40%_60%]   border-2 border-secondary rounded-xl `}
            >
              ...
              <figure className=" overflow-hidden lg:row-span-2  flex justify-center items-center">
                <img
                  src={project?.src}
                  alt="Project Image"
                  className="w-full h-full  lg:rounded-4xl  rounded-xl lg:h-[90%] pl-2 pr-4 "
                />
              </figure>

              <section className="flex flex-col justify-start  md:justify-center pt-4 gap-6  px-5 ">
                <article className=" flex flex-col gap-4">
                  <p className="hidden md:block text-xl font-serif">
                    These are all the main Technologies used in this project.
                  </p>
                        ...
                        return (
                          <Fragment key={index}>
                            <li className="lg:hidden inline ">
                              {tech +
                                `${
                                  index != project?.CoreStack.length - 1
                                    ? ", "
                                    : "."
                                }`}
                            </li>
                  ...
                  <section className="flex flex-col  items-center gap-5 md:flex-row">
                    ...
                    <NavLink
                      className="flex items-center px-4 py-2  border border-zinc-700 gap-4 rounded-lg w-[90%] md:w-[40%] lg:w-fit"
                      to={"/Projects/ProjectOverView"}
                      state={{ project, projectNumber: index + 1 }}
                    >
                  ...
                  <section className="hidden lg:flex  border border-zinc-700 rounded-lg justify-evenly items-center py-10">
                    ...
                    >
                      ...
                      <p className="lg:text-xl font-bold tracking-wider font-mono">
                        GitHub Code
                      </p>
                    </a>
                    <a
      ...
      <NavLink
        to={"Projects"}
        className="flex justify-center transition-all duration-600  items-center gap-2 text-3xl mb-20 mt-10  w-fit mx-auto  py-4 rounded-2xl group"
      >
        <p>Explore All Projects</p>
        <p className="group-hover:-translate-y-1 transition-all duration-400 group-hover:text-blue-300">
